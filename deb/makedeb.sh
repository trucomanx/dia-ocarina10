...
################################################################################
mkdir -p $INSTALLPATH/usr/share/dia/shapes/dia-ocarina10/
mkdir -p $INSTALLPATH/usr/share/dia/sheets/
cp -v -f $SRCPATH/dia-shapes/shapes/dia-ocarina10/*.png   $INSTALLPATH/usr/share/dia/shapes/dia-ocarina10/
cp -v -f $SRCPATH/dia-shapes/shapes/dia-ocarina10/*.shape $INSTALLPATH/usr/share/dia/shapes/dia-ocarina10/
