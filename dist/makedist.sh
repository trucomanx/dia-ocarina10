...
################################################################################
mkdir -p $INSTALLPATH/shapes/dia-ocarina10/
mkdir -p $INSTALLPATH/sheets/
cp -f $SRCPATH/dia-shapes/shapes/dia-ocarina10/*.png   $INSTALLPATH/shapes/dia-ocarina10/
cp -f $SRCPATH/dia-shapes/shapes/dia-ocarina10/*.shape $INSTALLPATH/shapes/dia-ocarina10/
