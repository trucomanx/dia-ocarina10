...
SHEET_FILE      := 'dia-shapes/sheets/dia-ocarina10.sheet'
...
uninstall:
	...
	rm -r -f ~/.dia/sheets/dia-ocarina10.sheet
...
clean:
	...
	$(RM) -r dia-shapes/shapes/dia-ocarina10/*.shape
	$(RM) -r dia-shapes/shapes/dia-ocarina10/*.png
